...
void main() async {
  group('Deposit Edda Your Bank Details Screen widget test', () {
    Future<void> _buildDepositEddaYourBankDetailsScreen(
        WidgetTester tester) async {
      final mockObserver = MockNavigatorObserver();
      await tester.pumpWidget(MaterialApp(
          home: const DepositScreen(
            initialDepositPages: DepositPageStep.eddaYourBankDetails,
          ),
    ...
    testWidgets(
        'Render Deposit Edda Your Bank Details Screen, `continue button` = disabled',
        (tester) async {
      await _buildDepositEddaYourBankDetailsScreen(tester);
      expect(
          find.text(
