import 'package:asklora_mobile_app/feature/payment/deposits/bloc/list_bank/select_bank_bloc.dart';
...
void main() {
  ...
  group('*Select Bank Bloc Test*', () {
    ...
    test('init state should be null', () async {
      expect(selectBankBloc.state, const SelectBankState(listBanks: []));
    });
