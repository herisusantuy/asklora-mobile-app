    ...
    () {
      ...
      testWidgets(
        ...
        await tester.tap(find.byKey(const Key(
            'Are you a United States tax resident, green card holder, or citizen?-No')));
        await tester.tap(find.byKey(const Key(
            'Are you a Hong Kong resident? By clicking yes, you acknowledge that you are also a Hong Kong tax resident-Yes')));
        await tester.pump();
        expect(
            (tester.widget(kycButtonPair) as ButtonPair).disablePrimaryButton,
            false);
