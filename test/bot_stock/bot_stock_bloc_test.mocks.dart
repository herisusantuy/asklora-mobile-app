...
class MockTutorialRepository extends _i1.Mock
    implements _i24.TutorialRepository {
  ...
  @override
  _i4.Future<bool> isTradeSummaryTutorial() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<bool> setTradeSummaryTutorialFinished() => (super.noSuchMethod(
        Invocation.method(
          #setTradeSummaryTutorialFinished,
          [],
        ),
        returnValue: _i4.Future<bool>.value(false),
      ) as _i4.Future<bool>);
