...
public class AndroidTest {
    ...
    String[] q1 = {"5 years or above", "3 to less then 5 years", "1 to less then 3 years", "Less than 1 year", "Never"};
    String[] q2 = {"more than HK$150,000", "HK$100,000-HK$149,999", "HK$50,000-HK$99,999", "HK$20,000-HK$49,999", "less than HK$ 20,000"};
    ...
    If you are using gui, go to advanced -> put "localhost" for server address and check "Allow CORS"
    If you are using cli, type "appium --address=locahost --allow-cors" into cmd or terminal

    Make sure JAVA_HOME and ANDROID_HOME are set up to use this program to automate creating an account
    ...
    You should be able to input the otp and confirm you uploaded an image after restarting IDE

    There is one part where automation would not work
    - You must manually take a picture of the HKID and selfie in order for the program to continue
        - I have it set to wait for 2 minutes for you to complete the Onfido authorization section
     */
    ...
    public void setUp() throws IOException {
        ...
        // make sure you change the apk to the same version as the one on your phone
        caps.setCapability("app", System.getProperty("user.dir")+"/apps/asklora_stag_10120.apk");
...
//        caps.setCapability("autoLaunch", false);
    ...
    public void testPrivacy() {
        ...
        clickOption(q1[randomize(0, 2)]);
        clickNext();
        clickOption(q2[randomize(0, 2)]);
        clickNext();
        clickOption(q3[randomize(0, 2)]);
        clickNext();
        clickOption(q4[randomize(0, 2)]);
        clickNext();
    ...
    public void testPersonality() {
        ...
        clickNext();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.Button[@content-desc='Got It']")));
    ...
    public void testSignUp() {
        ...
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Sign Up\"))")).click();
    }
    ...
    public void testVerifyEmail() throws InterruptedException {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[contains(@content-desc, 'sent an email to')]")));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.EditText[contains(@text, 'test')]")));
        ...
        wait.until(ExpectedConditions.textToBePresentInElement(driver.findElement(By.xpath("//android.widget.EditText[contains(@text, 'test')]")), email));
        driver.findElement(By.className("android.widget.Button")).click();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.Button[contains(@text, 'Asklora')]")));
        driver.findElement(By.xpath("//android.widget.Button[contains(@text, 'Asklora')]")).click();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@content-desc='Verify Email']")));
        ...
        if (!(driver.findElement(By.id("android:id/button_once")).isEnabled())) { // Check if the "Just Once" Button is disabled
            driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiSelector().textContains(\"Stag\")")).click();
            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
    ...
    public void testInvestmentStyle() {
        driver.findElement(By.xpath("//android.widget.Button[@content-desc='Define Investment Style']")).click();
        clickEditText();
        ...
        clickNext();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.Button[contains(@content-desc, 'Investment')]")));
        driver.findElement(By.xpath("//android.widget.Button[contains(@content-desc, 'Investment Account')]")).click();
    }

    @Test(priority = 7, dependsOnMethods = {"testInvestmentStyle"})
    public void testAccountSetUp() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[contains(@content-desc, 'Account opening and deposit')]")));
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Open Account Now\"))")).click();
        ...
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Nationality\"))")).click();
        driver.findElement(By.xpath("//android.view.View[contains(@content-desc, 'Hong Kong SAR')]")).click();
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Country Of Birth\"))")).click();
//        driver.findElement(By.xpath("//android.view.View[contains(@content-desc, 'Date of Birth')]")).click();
//        setDateOfBirth();
...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("android:id/text1")));
        ...
        try {
            ...
            driver.findElement(By.className("android.widget.EditText")).sendKeys(phoneNum);
        }
        clickNext();
        getOTP();
    }
    ...
    public void testAddress() {
        ...
        driver.findElement(By.xpath("//android.view.View[contains(@content-desc, 'Hong Kong Island')]")).click();
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().className(\"android.widget.ImageView\"))")).click();
        getImage();
        clickNext();
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Confirm & Continue\").instance(0))")).click();
//        driver.findElement(By.xpath("//android.widget.Button[@content-desc='Confirm & Continue']")).click();
    }

    @Test(priority = 9, dependsOnMethods = {"testAddress"})
    public void testFinancialProfile() {
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"No\"))")).click();
        driver.findElement(By.xpath("//android.widget.Button[contains(@content-desc, 'Employment Status')]")).click();
        ...
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Confirm & Continue\"))")).click();
        ...
        driver.findElement(By.xpath("//android.widget.ImageView[contains(@content-desc, 'Asklora Customer Agreement')]")).click();
        ...
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().className(\"android.widget.CheckBox\"))")).click();
        driver.findElement(By.xpath("//android.widget.Button[@content-desc='Agree']")).click();
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().className(\"android.widget.CheckBox\"))")).click();
        clickEditText();
        ...
        driver.findElement(By.xpath("//android.widget.Button[@content-desc='Agree']")).click();
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Complete\").instance(0))")).click();
    }

    @Test(priority = 10, dependsOnMethods = {"testFinancialProfile"})
    public void testDepositFunds() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.Button[contains(@content-desc, 'Deposit Funds')]")));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.Button[@content-desc='Done']")));
    ...
    public void clickBegin() {
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Begin\"))")).click();
    }

    public void clickNext() {
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"Next\"))")).click();
    }

    public void clickOption(String option) {
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().descriptionContains(\"" + option + "\"))")).click();
    }

    public void clickEditText() {
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().className(\"android.widget.EditText\"))")).click();
    }
    ...
    public void getOTP() {
        if (deviceName.contains("M2101K9G")) {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.widget.Button[contains(@content-desc, 'Copy')]")));
            driver.findElement(By.xpath("//android.widget.Button[contains(@content-desc, 'Copy')]")).click();
    ...
    public void getImage() {
        if (deviceName.contains("M2101K9G")) {
            ...
            driver.findElement(By.id("android:id/button_once")).click();
            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
            List<WebElement> photoWidget = driver.findElements(By.className("android.widget.RelativeLayout"));
            System.out.println("Image relative layout: " + photoWidget);
            driver.findElement(By.className("android.widget.RelativeLayout")).click();
            driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc='Photo taken on 7 Jun 2023 21:30:08']")).click();
        } else {
            Scanner scanner = new Scanner(System.in);
