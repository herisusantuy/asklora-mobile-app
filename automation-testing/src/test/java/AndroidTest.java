...
public class AndroidTest {
    ...
    String firstName = "";
    String lastName = "";
    String hkid = "V9918027";
    String phoneNum = "55954293";
...
//        System.out.println(os);
        ...
        caps.setCapability("app", System.getProperty("user.dir") + "/apps/asklora_stag_10187.apk");
    ...
    public void testBegin() throws IOException {
        ...
        clickBegin();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
        driver.findElement(By.className("android.widget.EditText")).sendKeys(firstName); // enter
        // firstName
        clickNext();
    ...
    public void testPrivacy() throws IOException {
        ...
        clickNext();
        driver.findElement(By.className("android.widget.EditText")).sendKeys(String.valueOf(age)); // enter
        // age
        clickNext();
    ...
    public void testVerifyEmail() throws IOException {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));
        wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.className("android.widget.EditText")));
    ...
    public void testInvestmentStyle() throws IOException {
        ...
        driver.findElement(By.xpath(
                        "//android.widget.Button[contains(@content-desc, 'Investment Account')]"))
                .click();
    }
    ...
    public void testAccountSetUp() throws IOException {
        ...
        driver.findElement(new AppiumBy.ByAndroidUIAutomator(
                ...
                .click();
        driver.findElement(By.xpath("//android.view.View[contains(@content-desc, 'Hong Kong SAR')]"))
                .click();
        driver.findElement(new AppiumBy.ByAndroidUIAutomator(
                        "new UiScrollable(new UiSelector().scrollable(true))" +
    ...
    public void testAddress() throws IOException {
        ...
        driver.findElement(By.xpath("//android.widget.Button[contains(@content-desc, 'District')]"))
                .click();
        driver.findElement(By.xpath("//android.view.View[contains(@content-desc, 'Islands')]")).click();
        driver.findElement(By.xpath("//android.widget.Button[contains(@content-desc, 'Region')]"))
                .click();
    ...
    public void testFinancialProfile() throws IOException {
        ...
        clickNext();
        driver.findElement(By.xpath("//android.view.View[@content-desc='Income from Employment']"))
                .click();
        clickNext();
    ...
    public void testDepositFunds() throws IOException {
        ...
        clickEditText();
        driver.findElement(By.className("android.widget.EditText")).sendKeys("10000");
        ...
        wait.until(ExpectedConditions
                .visibilityOfElementLocated(
                        By.xpath("//android.widget.Button[@content-desc='Done']")));
    ...
    public void getImage() {
        ...
        driver.findElement(By.xpath("//android.view.ViewGroup[contains(@content-desc, 'Photo')]")).click();
    }
